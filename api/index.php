...
switch ($endpoint) {
	...
	default:
		...
		echo json_encode(array("API: ListDevice", "Usage: Lists all device types and manufacturers", "Parameters:None", "How to run:/equipment/api/?ListDevice", "Errors: None"), JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES);
		echo json_encode(array("API: AddDevice", "Usage: Adds a device", "Parameters:device_type=device_type&manufacturer=manufacturers&sn=serial_number", "How to run:/equipment/api/?AddDevice&Parameters", "Errors: All fields are required | Serial number already taken | Device type or manufacturer doesn't exists"), JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES);
		...
		echo json_encode(array("API: ViewFile", "Usage: View upload file", "Parameters:id=validID&file_path_to_view=file_path", "How to run:/equipment/api/?ViewFile&Parameteres", "Errors: ID is invalid | Device ID dosen't exists | file dosen't exist"), JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES);
